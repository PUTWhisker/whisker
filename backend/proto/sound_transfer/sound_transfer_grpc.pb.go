...
func (x *soundServiceStreamSoundFileClient) Recv() (*SoundResponse, error) {
	m := new(SoundResponse)
...
func (x *soundServiceStreamSoundFileServer) Send(m *SoundResponse) error {
