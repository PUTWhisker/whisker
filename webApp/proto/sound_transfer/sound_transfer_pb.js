...
goog.exportSymbol('proto.TextAndId', null, global);
 ...
 * @constructor
 */
proto.TextAndId = function(opt_data) {
  jspb.Message.initialize(this, opt_data, 0, -1, null, null);
};
goog.inherits(proto.TextAndId, jspb.Message);
if (goog.DEBUG && !COMPILED) {
  /**
   * @public
   * @override
   */
  proto.TextAndId.displayName = 'proto.TextAndId';
}
 ...
 * @return {number}
 */
proto.SoundResponse.prototype.getId = function() {
 ...
 * @return {!proto.SoundResponse} returns this
 */
proto.SoundResponse.prototype.setId = function(value) {
 ...
 * @return {!Object}
 */
proto.TextAndId.prototype.toObject = function(opt_includeInstance) {
  return proto.TextAndId.toObject(opt_includeInstance, this);
};
 ...
 *     the JSPB instance for transitional soy proto support:
 *     http://goto/soy-param-migration
 * @param {!proto.TextAndId} msg The msg instance to transform.
 * @return {!Object}
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.TextAndId.toObject = function(includeInstance, msg) {
  var f, obj = {
    text: jspb.Message.getFieldWithDefault(msg, 1, ""),
    textLanguage: jspb.Message.getFieldWithDefault(msg, 3, ""),
    translationLanguage: jspb.Message.getFieldWithDefault(msg, 4, "")
  };
 ...
 * Deserializes binary data (in protobuf wire format).
 * @param {jspb.ByteSource} bytes The bytes to deserialize.
 * @return {!proto.TextAndId}
 */
proto.TextAndId.deserializeBinary = function(bytes) {
  var reader = new jspb.BinaryReader(bytes);
  var msg = new proto.TextAndId;
  return proto.TextAndId.deserializeBinaryFromReader(msg, reader);
};
 ...
 * Deserializes binary data (in protobuf wire format) from the
 * given reader into the given message object.
 * @param {!proto.TextAndId} msg The message object to deserialize into.
 * @param {!jspb.BinaryReader} reader The BinaryReader to use.
 * @return {!proto.TextAndId}
 */
proto.TextAndId.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    if (reader.isEndGroup()) {
      break;
    }
 ...
 * @return {!Uint8Array}
 */
proto.TextAndId.prototype.serializeBinary = function() {
  var writer = new jspb.BinaryWriter();
  proto.TextAndId.serializeBinaryToWriter(this, writer);
  return writer.getResultBuffer();
};
 ...
 * Serializes the given message to binary data (in protobuf wire
 * format), writing to the given BinaryWriter.
 * @param {!proto.TextAndId} message
 * @param {!jspb.BinaryWriter} writer
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.TextAndId.serializeBinaryToWriter = function(message, writer) {
  var f = undefined;
  f = message.getText();
  if (f.length > 0) {
    writer.writeString(
 ...
 * @return {string}
 */
proto.TextAndId.prototype.getText = function() {
  return /** @type {string} */ (jspb.Message.getFieldWithDefault(this, 1, ""));
};
...
/**
 * @param {string} value
 * @return {!proto.TextAndId} returns this
 */
proto.TextAndId.prototype.setText = function(value) {
  return jspb.Message.setProto3StringField(this, 1, value);
};
 ...
 * @return {string}
 */
proto.TextAndId.prototype.getTextLanguage = function() {
  return /** @type {string} */ (jspb.Message.getFieldWithDefault(this, 3, ""));
};
 ...
 * @return {!proto.TextAndId} returns this
 */
proto.TextAndId.prototype.setTextLanguage = function(value) {
  return jspb.Message.setProto3StringField(this, 3, value);
};


/**
 * optional string translation_language = 4;
 * @return {string}
 */
proto.TextAndId.prototype.getTranslationLanguage = function() {
  return /** @type {string} */ (jspb.Message.getFieldWithDefault(this, 4, ""));
};
 ...
 * @return {!proto.TextAndId} returns this
 */
proto.TextAndId.prototype.setTranslationLanguage = function(value) {
  return jspb.Message.setProto3StringField(this, 4, value);
};
