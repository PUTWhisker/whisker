 ...
 * @const
 */
proto.DiarizationHistory.repeatedFields_ = [2,3];
...
proto.DiarizationHistory.toObject = function(includeInstance, msg) {
  var f, obj = {
    id: jspb.Message.getFieldWithDefault(msg, 1, 0),
    speakerList: (f = jspb.Message.getRepeatedField(msg, 2)) == null ? undefined : f,
    lineList: (f = jspb.Message.getRepeatedField(msg, 3)) == null ? undefined : f,
    createdAt: (f = msg.getCreatedAt()) && google_protobuf_timestamp_pb.Timestamp.toObject(includeInstance, f)
  };
 ...
 * @return {number}
 */
proto.DiarizationHistory.prototype.getId = function() {
  return /** @type {number} */ (jspb.Message.getFieldWithDefault(this, 1, 0));
};
 ...
 */
proto.DiarizationHistory.prototype.setId = function(value) {
  return jspb.Message.setProto3IntField(this, 1, value);
};
