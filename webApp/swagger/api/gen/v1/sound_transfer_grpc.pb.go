...
type SoundServiceClient interface {
	// This is the description put above TestConnection
	TestConnection(ctx context.Context, in *TextMessage, opts ...grpc.CallOption) (*TextMessage, error)
	// This is the description put above TranscribeFile
...
var SoundService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "sound_transfer.SoundService",
	...
	Metadata: "v1/sound_transfer.proto",
}
